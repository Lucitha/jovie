                        ...
                        <div class="col-lg-6">
                            <div class="job-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <i class='bx bx-location-plus'></i> Wellesley Rd, London
                                    </li>
                                    <li>
                                        <i class='bx bx-filter-alt'></i> Accountancy
                                    </li>
                                    <li>
                                        <i class='bx bx-briefcase'></i> Freelance
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="job-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <i class='bx bx-location-plus'></i> West Sight, USA
                                    </li>
                                    <li>
                                        <i class='bx bx-filter-alt'></i> Graphics
                                    </li>
                                    <li>
                                        <i class='bx bx-briefcase'></i> Freelance
                                    </li>
                        ...
                        <div class="col-lg-3">
                            <div class="job-save">
                                ...
                                <p>
                                    <i class='bx bx-stopwatch'></i> 4 Hr Ago
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="job-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <i class='bx bx-location-plus'></i> San Francisco, California
                                    </li>
                                    <li>
                                        <i class='bx bx-filter-alt'></i> Development
                                    </li>
                                    <li>
                                        <i class='bx bx-briefcase'></i> Freelance
                                    </li>
                        ...
                        <div class="col-lg-3">
                            <div class="job-save">
                                ...
                                <p>
                                    <i class='bx bx-stopwatch'></i> 5 Hr Ago
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="job-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <i class='bx bx-filter-alt'></i> Marketing
                                    </li>
                                    <li>
                                        <i class='bx bx-briefcase'></i> Freelance
                                    </li>
                        ...
                        <div class="col-lg-3">
                            <div class="job-save">
                                ...
                                <p>
                                    <i class='bx bx-stopwatch'></i> 6 Hr Ago
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="job-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <i class='bx bx-location-plus'></i> Zoo Rd, London
                                    </li>
                                    <li>
                                        <i class='bx bx-filter-alt'></i> Accountancy
                                    </li>
                        ...
                        <div class="col-lg-3">
                            <div class="job-save">
                                ...
                                <p>
                                    <i class='bx bx-stopwatch'></i> 8 Hr Ago
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="job-info">
                                ...
                                <ul>
                                    <li>Via <a href="#">Tourt Design LTD</a></li>
                                    <li>
                                        <i class='bx bx-location-plus'></i> Green View, Australia
                                    </li>
                                    <li>
                                        <i class='bx bx-filter-alt'></i> Finance
                                    </li>
                                    <li>
